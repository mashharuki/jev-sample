...
const demoCases: {
    ...
    },
    {
        ...
        result: {
            ...
            reason: {
                message:
                    "入力が40,000文字を超えたため、Jev の判別を省略しました。",
            },
        },
    },
];
...
function App() {
    ...
    const activeResult =
        demo === null ? detail?.result : demoCases[demo]?.result;
        ...
        <div className="app-shell">
            ...
            <main>
                <section className="hero">
                    <div>
                        <p className="eyebrow">
                            TRANSACTION INTELLIGENCE / MONITOR
                        </p>
                        <h1>
                            取引の動きを、
                            <br />
                        ...
                        <p className="intro">
                            Base Sepolia のオンチェーンデータを Jev
                            が分類。選んだ取引だけ Gemini が詳しく解説します。
                        </p>
                    </div>
                    ...
                    <div className="status-card">
                        ...
                        <small>
                            {health?.worker?.message ||
                                "Base Sepolia の確定ブロックを待機"}
                        </small>
                    </div>
                    <div className="status-card">
                        <span>LAST PROCESSED BLOCK</span>
                        <strong className="mono">
                            {health?.checkpoint?.blockNumber?.toLocaleString(
                                "ja-JP",
                            ) || "—"}
                        </strong>
                                ...
                                <div className="comparison">
                                    <article className="comparison-card fact-card">
                                        ...
                                        <div className="card-result">
                                            ...
                                            <p>
                                                イベント:{" "}
                                                {evidence?.logs?.length || 0} 件
                                            </p>
                                        </div>
                                        <small>
                                            ABI
                                            の一致はコントラクトの規格準拠を保証しません。
                                        </small>
                                    </article>
            ...
            <footer>
                ...
                <span>
                    ON-CHAIN FACTS / JEV CLASSIFICATION / GEMINI EXPLANATION
                </span>
            </footer>
        </div>
    );
